...
const messages: Record<SupportedLocale, Record<TranslationKey, string>> = {
  'zh-CN': {
    ...
    'panel.uptime': '可用率',
    'panel.uptimeDelayHint': '可用率来自 OpenRouter 近 30 分钟统计并采用连续温和降权；故障与恢复可能存在检测延迟。',
    ...
    'settings.group.advanced.title': '筛选与可靠性（阈值以下 5% 区间渐进降权）',
  ...
  'en-US': {
    ...
    'panel.uptime': 'uptime',
    'panel.uptimeDelayHint': 'Uptime uses a continuous mild penalty over OpenRouter\'s trailing 30-minute statistics; failures and recoveries may be detected with a delay.',
    ...
    'settings.group.advanced.title': 'Filtering & reliability (gradual penalty across 5% below threshold)',
